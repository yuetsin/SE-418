/*!
 * ETUI - Min - JS - v3.12 前端框架标准规范
 *
 * Copyright - 2018 - 东方怡动信息技术有限公司  
 */
...
c.prototype=d.extend({},d.fn.tooltip.Constructor.prototype);c.prototype.constructor=c;c.prototype.getDefaults=function(){return c.DEFAULTS};c.prototype.setContent=function(){var g=this.tip();var f=this.getTitle();var e=this.getContent();g.find(".popover-title")[this.options.html?"html":"text"](f);g.find(".popover-content").children().detach().end()[this.options.html?(typeof e=="string"?"html":"append"):"text"](e);g.removeClass("fade top bottom left right in");if(!g.find(".popover-title").html()){g.find(".popover-title").hide()}};c.prototype.hasContent=function(){return this.getTitle()||this.getContent()};c.prototype.getContent=function(){var e=this.$element;var f=this.options;return e.attr("data-content")||(typeof f.content=="function"?f.content.call(e[0]):f.content)};c.prototype.arrow=function(){return(this.$arrow=this.$arrow||this.tip().find(".arrow"))};function b(e){return this.each(function(){var h=d(this);var g=h.data("bs.popover");var f=typeof e=="object"&&e;if(!g&&/destroy|hide/.test(e)){return}if(!g){h.data("bs.popover",(g=new c(this,f)))}if(typeof e=="string"){g[e]()}})}var a=d.fn.popover;d.fn.popover=b;d.fn.popover.Constructor=c;d.fn.popover.noConflict=function(){d.fn.popover=a;return this}}(jQuery);+function(d){function c(f,e){this.$body=d(document.body);this.$scrollElement=d(f).is(document.body)?d(window):d(f);this.options=d.extend({},c.DEFAULTS,e);this.selector=(this.options.target||"")+" .nav li > a";this.offsets=[];this.targets=[];this.activeTarget=null;this.scrollHeight=0;this.$scrollElement.on("scroll.bs.scrollspy",d.proxy(this.process,this));this.refresh();this.process()}c.VERSION="3.3.7";c.DEFAULTS={offset:10};c.prototype.getScrollHeight=function(){return this.$scrollElement[0].scrollHeight||Math.max(this.$body[0].scrollHeight,document.documentElement.scrollHeight)};c.prototype.refresh=function(){var g=this;var e="offset";var f=0;this.offsets=[];this.targets=[];this.scrollHeight=this.getScrollHeight();if(!d.isWindow(this.$scrollElement[0])){e="position";f=this.$scrollElement.scrollTop()}this.$body.find(this.selector).map(function(){var i=d(this);var h=i.data("target")||i.attr("href");var j=/^#./.test(h)&&d(h);return(j&&j.length&&j.is(":visible")&&[[j[e]().top+f,h]])||null}).sort(function(i,h){return i[0]-h[0]}).each(function(){g.offsets.push(this[0]);g.targets.push(this[1])})};c.prototype.process=function(){var k=this.$scrollElement.scrollTop()+this.options.offset;var g=this.getScrollHeight();var j=this.options.offset+g-this.$scrollElement.height();var h=this.offsets;var e=this.targets;var l=this.activeTarget;var f;if(this.scrollHeight!=g){this.refresh()}if(k>=j){return l!=(f=e[e.length-1])&&this.activate(f)}if(l&&k<h[0]){this.activeTarget=null;return this.clear()}for(f=h.length;f--;){l!=e[f]&&k>=h[f]&&(h[f+1]===undefined||k<h[f+1])&&this.activate(e[f])}};c.prototype.activate=function(g){this.activeTarget=g;this.clear();var e=this.selector+'[data-target="'+g+'"],'+this.selector+'[href="'+g+'"]';var f=d(e).parents("li").addClass("active");if(f.parent(".dropdown-menu").length){f=f.closest("li.dropdown").addClass("active")}f.trigger("activate.bs.scrollspy")};c.prototype.clear=function(){d(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};function b(e){return this.each(function(){var h=d(this);var g=h.data("bs.scrollspy");var f=typeof e=="object"&&e;if(!g){h.data("bs.scrollspy",(g=new c(this,f)))}if(typeof e=="string"){g[e]()}})}var a=d.fn.scrollspy;d.fn.scrollspy=b;d.fn.scrollspy.Constructor=c;d.fn.scrollspy.noConflict=function(){d.fn.scrollspy=a;return this};d(window).on("load.bs.scrollspy.data-api",function(){d('[data-spy="scroll"]').each(function(){var e=d(this);b.call(e,e.data())})})}(jQuery);+function(f){var c=function(k){this.element=f(k)};c.VERSION="3.3.5";c.TRANSITION_DURATION=150;c.prototype.show=function(){var q=this.element;if(q.parent("li").hasClass("active")){return}var m=q.closest("ul:not(.dropdown-menu)");var l=q.data("target");if(!l){l=q.attr("href");l=l&&l.replace(/.*(?=#[^\s]*$)/,"")}var o=m.find(".active:last a");var p=f.Event("hide.bs.tab",{relatedTarget:q[0]});var n=f.Event("show.bs.tab",{relatedTarget:o[0]});o.trigger(p);q.trigger(n);if(n.isDefaultPrevented()||p.isDefaultPrevented()){return}var k=f(l);this.activate(q.closest("li"),m);this.activate(k,k.parent(),function(){o.trigger({type:"hidden.bs.tab",relatedTarget:q[0]});q.trigger({type:"shown.bs.tab",relatedTarget:o[0]})})};c.prototype.activate=function(m,l,p){var k=l.find("> .active");var o=p&&f.support.transition&&(k.length&&k.hasClass("fade")||!!l.find("> .fade").length);function n(){k.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",false);m.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",true);if(o){m[0].offsetWidth;m.addClass("in")}else{m.removeClass("fade")}if(m.parent(".dropdown-menu").length){m.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",true)
}p&&p()}k.length&&o?k.one("bsTransitionEnd",n).emulateTransitionEnd(c.TRANSITION_DURATION):n();k.removeClass("in")};function j(k){return this.each(function(){var m=f(this);var l=m.data("bs.tab");if(!l){m.data("bs.tab",(l=new c(this)))}if(typeof k=="string"){l[k]()}})}var b=f.fn.tab;f.fn.tab=j;f.fn.tab.Constructor=c;f.fn.tab.noConflict=function(){f.fn.tab=b;return this};var h=function(k){k.preventDefault();j.call(f(this),"show")};f(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',h).on("click.bs.tab.data-api",'[data-toggle="pill"]',h);f('[data-toggle="tab"],[data-toggle="pill"]').bind("focus",h);f('[data-toggle="tab"],[data-toggle="pill"]').bind("mouseenter",h);var d="a:visible,button:visible,input:visible,textarea:visible,select:visible";var e=0;f("[data-toggle]").each(function(){var l=f(this);var k=a(l);k.css("display","block")});f("[data-toggle]").each(function(){var q=f(this);var k=a(q);g(q,k.find(d).first());i(k.find(d).first(),q);if(typeof(q.attr("tabtarget"))=="undefined"){var m=q.closest("ul:not(.dropdown-menu)");var p=m.find("li");if(p.length>1){for(var o=0;o<p.length-1;o++){var l=a(p.eq(o).find("a,input,button"));g(l.find(d).last(),p.eq(o+1).find("a,input,button"))}for(var o=1;o<p.length;o++){var n=p.eq(o-1).find("a,input,button");var l=a(n);i(p.eq(o).find("a,input,button"),l.find(d).last(),n)}}}});f("[data-toggle]").each(function(){var l=f(this);var k=a(l);k.css("display","")});function a(l){var k=l.data("target");if(!k){k=l.attr("href");if(k&&(k.toLowerCase().indexOf("http")==0||k.indexOf("/")>-1)){return f("#")}k=k&&k.replace(/.*(?=#[^\s]*$)/,"")}return f(k)}function g(l,k){e++;l.attr("totabtarget",e);k.attr("tabtarget",e)}function i(m,k,l){e++;m.attr("toretabtarget",e);k.attr("retabtarget",e);if(l){l.attr("retargetA",e)}}f("[totabtarget],[toretabtarget]").bind("keydown",function(m){var m=window.event?window.event:m;var l=m.which?m.which:m.keyCode;var n=null;if(l==9){if(!m.shiftKey){n=f("[tabtarget='"+f(this).attr("totabtarget")+"']")}else{n=f("[retabtarget='"+f(this).attr("toretabtarget")+"']");if(n.length>0){var k=f("[retargetA='"+f(this).attr("toretabtarget")+"']");if(k.length>0){event.preventDefault();j.call(k,"show")}}}if(n.length>0){n[0].focus();return false}}})}(jQuery);+function(d){var c=function(f,e){this.options=d.extend({},c.DEFAULTS,e);this.$target=d(this.options.target).on("scroll.bs.affix.data-api",d.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",d.proxy(this.checkPositionWithEventLoop,this));this.$element=d(f);this.affixed=null;this.unpin=null;this.pinnedOffset=null;this.checkPosition()};c.VERSION="3.3.7";c.RESET="affix affix-top affix-bottom";c.DEFAULTS={offset:0,target:window};c.prototype.getState=function(n,m,f,g){var e=this.$target.scrollTop();var i=this.$element.offset();var j=this.$target.height();if(f!=null&&this.affixed=="top"){return e<f?"top":false}if(this.affixed=="bottom"){if(f!=null){return(e+this.unpin<=i.top)?false:"bottom"}return(e+j<=n-g)?false:"bottom"}var h=this.affixed==null;var l=h?e:i.top;var k=h?j:m;if(f!=null&&e<=f){return"top"}if(g!=null&&(l+k>=n-g)){return"bottom"}return false};c.prototype.getPinnedOffset=function(){if(this.pinnedOffset){return this.pinnedOffset}this.$element.removeClass(c.RESET).addClass("affix");var f=this.$target.scrollTop();var e=this.$element.offset();return(this.pinnedOffset=e.top-f)};c.prototype.checkPositionWithEventLoop=function(){setTimeout(d.proxy(this.checkPosition,this),1)};c.prototype.checkPosition=function(){if(!this.$element.is(":visible")){return}var f=this.$element.height();var l=this.options.offset;var j=l.top;var h=l.bottom;var i=Math.max(d(document).height(),d(document.body).height());if(typeof l!="object"){h=j=l}if(typeof j=="function"){j=l.top(this.$element)}if(typeof h=="function"){h=l.bottom(this.$element)}var g=this.getState(i,f,j,h);if(this.affixed!=g){if(this.unpin!=null){this.$element.css("top","")}var m="affix"+(g?"-"+g:"");var k=d.Event(m+".bs.affix");this.$element.trigger(k);if(k.isDefaultPrevented()){return}this.affixed=g;this.unpin=g=="bottom"?this.getPinnedOffset():null;this.$element.removeClass(c.RESET).addClass(m).trigger(m.replace("affix","affixed")+".bs.affix")}if(g=="bottom"){this.$element.offset({top:i-f-h})}};function b(e){return this.each(function(){var h=d(this);var g=h.data("bs.affix");var f=typeof e=="object"&&e;if(!g){h.data("bs.affix",(g=new c(this,f)))}if(typeof e=="string"){g[e]()}})}var a=d.fn.affix;d.fn.affix=b;d.fn.affix.Constructor=c;d.fn.affix.noConflict=function(){d.fn.affix=a;return this};d(window).on("load",function(){d('[data-spy="affix"]').each(function(){var f=d(this);var e=f.data();e.offset=e.offset||{};if(e.offsetBottom!=null){e.offset.bottom=e.offsetBottom}if(e.offsetTop!=null){e.offset.top=e.offsetTop}b.call(f,e)})})}(jQuery);